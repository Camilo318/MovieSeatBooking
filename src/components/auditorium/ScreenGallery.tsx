        ...
        {hasGallery && (
          <>
            <Button
              ...
              onClick={() => stepStill(-1)}
              className='screen-nav absolute top-1/2 left-2.5 size-8.5 -translate-y-1/2 rounded-full border-white/18 bg-nav/45 text-white/82 opacity-30 backdrop-blur-sm hover:opacity-100 hover:bg-nav/72 hover:border-white/34'>
              <ChevronLeftIcon />
            </Button>
            <Button
              type='button'
              ...
              onClick={() => stepStill(1)}
              className='screen-nav absolute top-1/2 right-2.5 size-8.5 -translate-y-1/2 rounded-full border-white/18 bg-nav/45 text-white/82 opacity-30 backdrop-blur-sm hover:opacity-100 hover:bg-nav/72 hover:border-white/34'>
              <ChevronRightIcon />
            </Button>
          </>
        )}
